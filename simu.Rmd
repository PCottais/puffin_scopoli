...
moves <- function(steps){
  ...
  # probabilities of the associated kernel
  available_probs <- envi_dt[(latitude-1):(latitude+1),
                     (longitude-1):(longitude+1)] %>% as_vector()
  ...
  for(i in 1:steps){
    ...
    # gestion des cas où l'animal touche les frontières du "paysage"
    if (latitude==nrow(envi_dt) | longitude==ncol(envi_dt) |
      ...
      return(list(coord_dt, available_probs))
    }else{
